...
# Code School - Java - TestNG - Lesson 1 - Exercise

## Introduction

This code provides the solution to the practical exercise that was given out at the end of Lesson 1.
...
```sh
git clone https://github.com/BS-Code-School-Templates/Java-Web-TestNG-Lesson-1-Exercise.git
```
* Move into the directory that you just cloned by typing
```sh
cd Java-Web-TestNG-Lesson-1-Exercise
```
